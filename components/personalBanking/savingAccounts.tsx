...
import { PiggyBank, Check, ArrowRight, Shield, Target } from 'lucide-react';
import GrainOverlay from '@/components/shared/grainOverlay';
import { savingsProducts } from '@/data/personalBanking/savings';
        ...
        <div className="px-6 lg:px-8 py-20">
          <div className="max-w-6xl mx-auto text-center mb-16">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
              Smart <span className="text-blue-400">Savings</span> Accounts
            </h1>
          ...
          <div className="max-w-6xl mx-auto">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-6">
                      ...
                      <div>
                        <div className="text-sm text-gray-500 mb-1">Min Balance</div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-white mb-2">FSCS Protected</h4>
                <p className="text-gray-400">Your deposits are protected up to £85,000</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-white mb-2">No Hidden Fees</h4>
                <p className="text-gray-400">Transparent pricing with no monthly charges</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h4 className="text-lg font-semibold text-white mb-2">Competitive Rates</h4>
                <p className="text-gray-400">Market-leading interest rates on all accounts</p>
              </div>
            </div>
            ...
            <div className="text-center bg-gradient-to-r from-blue-500/10 to-blue-500/5 rounded-2xl p-12 border border-blue-500/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button className="relative px-10 py-4 rounded-xl font-bold text-lg transition-all duration-300 flex items-center justify-center gap-3 group overflow-hidden">
                  ...
                  {/* Content */}
                  <PiggyBank className="relative w-6 h-6 text-black z-10" />
                  <span className="relative text-black z-10">Start Saving Today</span>
                </button>
